...
{
  return CALL_BASECRYPTLIB (AesCtr.Services.Encrypt, AesCtrEncrypt, (Key, KeySize, Iv, IvSize, DataIn, DataInSize, DataOut, DataOutSize), FALSE);
}
...
{
  return CALL_BASECRYPTLIB (AesCtr.Services.Decrypt, AesCtrDecrypt, (Key, KeySize, Iv, IvSize, DataIn, DataInSize, DataOut, DataOutSize), FALSE);
}
...
const EDKII_CRYPTO_PROTOCOL  mEdkiiCrypto = {
  ...
  CryptoServiceEdDsaSign,
  CryptoServiceEdDsaVerify,
  /// AES CTR (Continued at end for backward compatibility)
  CryptoServiceAesCtrEncrypt,
  CryptoServiceAesCtrDecrypt,
};
