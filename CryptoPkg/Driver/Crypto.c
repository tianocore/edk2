...
BOOLEAN
EFIAPI
CryptoServiceRsaPkcs1SignWithNid (
  IN      VOID         *RsaContext,
  IN      UINTN        HashNid,
  IN      CONST UINT8  *MessageHash,
  IN      UINTN        HashSize,
...
{
  return CALL_BASECRYPTLIB (Rsa.Services.Pkcs1SignWithNid, RsaPkcs1SignWithNid, (RsaContext, HashNid, MessageHash, HashSize, Signature, SigSize), FALSE);
}
...
BOOLEAN
EFIAPI
CryptoServiceRsaPkcs1VerifyWithNid (
  IN  VOID         *RsaContext,
  IN  UINTN        HashNid,
  IN  CONST UINT8  *MessageHash,
  IN  UINTN        HashSize,
...
{
  return CALL_BASECRYPTLIB (Rsa.Services.Pkcs1VerifyWithNid, RsaPkcs1VerifyWithNid, (RsaContext, HashNid, MessageHash, HashSize, Signature, SigSize), FALSE);
}
