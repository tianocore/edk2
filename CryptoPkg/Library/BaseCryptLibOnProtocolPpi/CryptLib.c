...
{
  CALL_CRYPTO_SERVICE (AesCtrEncrypt, (Key, KeySize, Iv, IvSize, DataIn, DataInSize, DataOut, DataOutSize), FALSE);
}
...
{
  CALL_CRYPTO_SERVICE (AesCtrDecrypt, (Key, KeySize, Iv, IvSize, DataIn, DataInSize, DataOut, DataOutSize), FALSE);
}
