...
/**
  ...
  @return     Pointer to the Elliptic Curve Context that has been initialized.
              If the allocations fails, SlhDsaNewByNid() returns NULL.
**/
VOID *
EFIAPI
SlhDsaNewByNid (
  ...
  )
{
  ...
  Ctx = (SlhDsaCtx *)AllocateZeroPool (sizeof (SlhDsaCtx));
  if (Ctx == NULL) { 
    return NULL;
  }
...
/**
  ...
  The Slh context should be correctly initialized by SlhDsaNewByNid, and successfully
