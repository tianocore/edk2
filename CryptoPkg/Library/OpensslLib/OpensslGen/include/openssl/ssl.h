...
typedef void (*SSL_custom_ext_free_cb_ex)(
  SSL                  *s,
  unsigned int         ext_type,
  unsigned int         context,
  const unsigned char  *out,
...
/* see tls_srp.c */
  #ifndef OPENSSL_NO_DEPRECATED_3_0
OSSL_DEPRECATEDIN_3_0 __owur int
SSL_SRP_CTX_init (
  SSL  *s
  );
...
SSL_CTX_set_stateless_cookie_verify_cb (
  SSL_CTX  *ctx,
  int (    *verify_stateless_cookie_cb )(
        SSL                  *ssl,
...
typedef unsigned int (*SSL_psk_client_cb_func)(
  SSL            *ssl,
  const char     *hint,
  char           *identity,
...
typedef unsigned int (*SSL_psk_server_cb_func)(
  SSL            *ssl,
  const char     *identity,
  unsigned char  *psk,
  unsigned int   max_psk_len
...
OSSL_DEPRECATEDIN_3_0 __owur BIGNUM *
SSL_get_srp_g (
  SSL  *s
  );
...
OSSL_DEPRECATEDIN_3_0 __owur char *
...
SSL_CTX_set_ssl_version (
  ...
  #ifndef OPENSSL_NO_DEPRECATED_1_1_0
OSSL_DEPRECATEDIN_1_1_0 __owur const SSL_METHOD *
SSLv3_method (
  void
  );                                                                 /* SSLv3 */
...
__owur  STACK_OF (SSL_COMP) *SSL_COMP_set0_compression_methods (
                               STACK_OF (SSL_COMP)
                               *meths
                               );
#ifndef OPENSSL_NO_DEPRECATED_1_1_0
...
__owur const struct openssl_ssl_test_functions *
SSL_test_functions (
  void
  );
