...
typedef OSSL_CMP_MSG *(*OSSL_CMP_transfer_cb_t) (
  OSSL_CMP_CTX        *ctx,
...
typedef OSSL_CMP_PKISI *(*OSSL_CMP_SRV_rr_cb_t)(
  OSSL_CMP_SRV_CTX    *srv_ctx,
  const OSSL_CMP_MSG  *req,
...
typedef int (*OSSL_CMP_SRV_certConf_cb_t)(
  OSSL_CMP_SRV_CTX         *srv_ctx,
  const OSSL_CMP_MSG       *req,
  int                      certReqId,
...
typedef int (*OSSL_CMP_SRV_pollReq_cb_t)(
  OSSL_CMP_SRV_CTX    *srv_ctx,
  const OSSL_CMP_MSG  *req,
  int                 certReqId,
...
OSSL_CMP_SRV_CTX_get0_cmp_ctx (
  const OSSL_CMP_SRV_CTX  *srv_ctx
  );
