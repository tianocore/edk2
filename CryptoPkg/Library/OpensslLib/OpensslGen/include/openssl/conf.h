...
LHASH_OF (CONF_VALUE) *CONF_load_fp (
                         LHASH_OF (CONF_VALUE) *conf,
                         FILE *fp,
                         long *eline
                         );
#endif
LHASH_OF (CONF_VALUE) *CONF_load_bio (
                         LHASH_OF (CONF_VALUE) *conf,
                         BIO *bp,
                         long *eline
                         );
STACK_OF (CONF_VALUE) *CONF_get_section (
                         LHASH_OF (CONF_VALUE) *conf,
                         const char *section
                         );
...
#ifndef OPENSSL_NO_DEPRECATED_3_0
OSSL_DEPRECATEDIN_3_0 CONF_METHOD *
NCONF_WIN32 (
  void
  );
...
STACK_OF (CONF_VALUE) *NCONF_get_section (
                         const CONF *conf,
                         const char *section
                         );
char *
