...
MOCK_FUNCTION_DEFINITION (MockBaseCryptLib, HkdfSha512ExtractAndExpand, 8, EFIAPI);
MOCK_FUNCTION_DEFINITION (MockBaseCryptLib, HkdfSha512Extract, 6, EFIAPI);
MOCK_FUNCTION_DEFINITION (MockBaseCryptLib, HkdfSha512Expand, 6, EFIAPI);
...
MOCK_FUNCTION_DEFINITION (MockBaseCryptLib, EcGetCurveNid, 2, EFIAPI);
...
MOCK_FUNCTION_DEFINITION (MockBaseCryptLib, EcGetPublicKeyFromPem, 4, EFIAPI);
MOCK_FUNCTION_DEFINITION (MockBaseCryptLib, EcPublicKeyToPEM, 3, EFIAPI);
