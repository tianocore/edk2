...
/**
  ...
  Pass the API a pkcs7 detached (without content data) and no attributes,contents return should be null.
  ...
  )
{
  ...
  SignedDataSize = sizeof (Pck7DetachedNoAttributesTest);

  Status = Pkcs7GetAttachedContent (
                                    Pck7DetachedNoAttributesTest,
                                    SignedDataSize,
                                    (VOID **)&AttachedData,
                                    &AttachedDataSize
                                    );
