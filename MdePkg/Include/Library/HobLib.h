...
/**
  Returns the owner GUID from a Resource Descriptor HOB (v1 or v2).
  ...
  @return A pointer to the resource owner GUID.

**/
#define GET_RESOURCE_HOB_OWNER(Hob)  \
  ((GET_HOB_TYPE (Hob) == EFI_HOB_TYPE_RESOURCE_DESCRIPTOR2) ? \
   &(Hob).ResourceDescriptor2->Owner :                           \
   &(Hob).ResourceDescriptor->Owner)

/**
  Returns the resource type from a Resource Descriptor HOB (v1 or v2).
...
**/
#define GET_RESOURCE_HOB_RESOURCE_TYPE(Hob)  \
  ((GET_HOB_TYPE (Hob) == EFI_HOB_TYPE_RESOURCE_DESCRIPTOR2) ? \
   (Hob).ResourceDescriptor2->ResourceType :                     \
   (Hob).ResourceDescriptor->ResourceType)

/**
  Returns the physical start address from a Resource Descriptor HOB (v1 or v2).
...
**/
#define GET_RESOURCE_HOB_PHYSICAL_START(Hob)  \
  ((GET_HOB_TYPE (Hob) == EFI_HOB_TYPE_RESOURCE_DESCRIPTOR2) ? \
   (Hob).ResourceDescriptor2->PhysicalStart :                    \
   (Hob).ResourceDescriptor->PhysicalStart)

/**
  Returns the resource length from a Resource Descriptor HOB (v1 or v2).
...
**/
#define GET_RESOURCE_HOB_RESOURCE_LENGTH(Hob)  \
  ((GET_HOB_TYPE (Hob) == EFI_HOB_TYPE_RESOURCE_DESCRIPTOR2) ? \
