...
MOCK_FUNCTION_DEFINITION (MockUefiBootServicesTableLib, gBS_ImageLoad, 6, EFIAPI);
MOCK_FUNCTION_DEFINITION (MockUefiBootServicesTableLib, gBS_ImageStart, 3, EFIAPI);
MOCK_FUNCTION_DEFINITION (MockUefiBootServicesTableLib, gBS_Exit, 2, EFIAPI);
MOCK_FUNCTION_DEFINITION (MockUefiBootServicesTableLib, gBS_ImageUnload, 1, EFIAPI);
...
MOCK_FUNCTION_DEFINITION (MockUefiBootServicesTableLib, gBS_ProtocolsPerHandle, 2, EFIAPI);
...
static EFI_BOOT_SERVICES  MockEfiBootServicesInstance = {
  ...
  (EFI_IMAGE_LOAD)gBS_ImageLoad,
  (EFI_IMAGE_START)gBS_ImageStart,
  (EFI_EXIT)gBS_Exit,
  (EFI_IMAGE_UNLOAD)gBS_ImageUnload,
