...
{
  return gUnitTestHostBaseLib.AsmCpuid (Index, Eax, Ebx, Ecx, Edx);
}
...
{
  return gUnitTestHostBaseLib.AsmCpuidEx (Index, SubIndex, Eax, Ebx, Ecx, Edx);
}
...
{
  gUnitTestHostBaseLib.AsmDisableCache ();
}
...
{
  gUnitTestHostBaseLib.AsmEnableCache ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadMsr64 (Index);
}
...
{
  return gUnitTestHostBaseLib.AsmWriteMsr64 (Index, Value);
}
...
{
  return gUnitTestHostBaseLib.AsmReadCr0 ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadCr2 ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadCr3 ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadCr4 ();
}
...
{
  return gUnitTestHostBaseLib.AsmWriteCr0 (Cr0);
}
...
{
  return gUnitTestHostBaseLib.AsmWriteCr2 (Cr2);
}
...
{
  return gUnitTestHostBaseLib.AsmWriteCr3 (Cr3);
}
...
{
  return gUnitTestHostBaseLib.AsmWriteCr4 (Cr4);
}
...
{
  return gUnitTestHostBaseLib.AsmReadDr0 ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadDr1 ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadDr2 ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadDr3 ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadDr4 ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadDr5 ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadDr6 ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadDr7 ();
}
...
{
  return gUnitTestHostBaseLib.AsmWriteDr0 (Dr0);
}
...
{
  return gUnitTestHostBaseLib.AsmWriteDr1 (Dr1);
}
...
{
  return gUnitTestHostBaseLib.AsmWriteDr2 (Dr2);
}
...
{
  return gUnitTestHostBaseLib.AsmWriteDr3 (Dr3);
}
...
{
  return gUnitTestHostBaseLib.AsmWriteDr4 (Dr4);
}
...
{
  return gUnitTestHostBaseLib.AsmWriteDr5 (Dr5);
}
...
{
  return gUnitTestHostBaseLib.AsmWriteDr6 (Dr6);
}
...
{
  return gUnitTestHostBaseLib.AsmWriteDr7 (Dr7);
}
...
{
  return gUnitTestHostBaseLib.AsmReadCs ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadDs ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadEs ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadFs ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadGs ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadSs ();
}
...
{
  return gUnitTestHostBaseLib.AsmReadTr ();
}
...
{
  gUnitTestHostBaseLib.AsmReadGdtr (Gdtr);
}
...
{
  gUnitTestHostBaseLib.AsmWriteGdtr (Gdtr);
}
...
{
  gUnitTestHostBaseLib.AsmReadIdtr (Idtr);
}
...
{
  gUnitTestHostBaseLib.AsmWriteIdtr (Idtr);
}
...
{
  return gUnitTestHostBaseLib.AsmReadLdtr ();
}
...
{
  gUnitTestHostBaseLib.AsmWriteLdtr (Ldtr);
}
...
{
  return gUnitTestHostBaseLib.AsmReadPmc (Index);
}
...
{
  return gUnitTestHostBaseLib.AsmMonitor (Eax, Ecx, Edx);
}
...
{
  return gUnitTestHostBaseLib.AsmMwait (Eax, Ecx);
}
...
{
  gUnitTestHostBaseLib.AsmWbinvd ();
}
...
{
  return gUnitTestHostBaseLib.AsmFlushCacheLine (LinearAddress);
}
...
{
  gUnitTestHostBaseLib.AsmEnablePaging32 (EntryPoint, Context1, Context2, NewStack);
}
...
{
  gUnitTestHostBaseLib.AsmDisablePaging32 (EntryPoint, Context1, Context2, NewStack);
}
...
{
  gUnitTestHostBaseLib.AsmEnablePaging64 (Cs, EntryPoint, Context1, Context2, NewStack);
}
...
{
  gUnitTestHostBaseLib.AsmDisablePaging64 (Cs, EntryPoint, Context1, Context2, NewStack);
}
...
{
  gUnitTestHostBaseLib.AsmGetThunk16Properties (RealModeBufferSize, ExtraStackSize);
}
...
{
  gUnitTestHostBaseLib.AsmPrepareThunk16 (ThunkContext);
}
...
{
  gUnitTestHostBaseLib.AsmThunk16 (ThunkContext);
}
...
{
  gUnitTestHostBaseLib.AsmPrepareAndThunk16 (ThunkContext);
}
...
{
  gUnitTestHostBaseLib.AsmWriteTr (Selector);
}
...
{
  gUnitTestHostBaseLib.AsmLfence ();
}
...
{
  gUnitTestHostBaseLib.PatchInstructionX86 (InstructionEnd, PatchValue, ValueSize);
}
...
/// default.  A specific unit test can provide their own implementation for any
/// of these functions.
///
