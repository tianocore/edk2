...
{
  gUnitTestHostBaseLib.EnableInterrupts ();
}
...
{
  gUnitTestHostBaseLib.DisableInterrupts ();
}
...
{
  gUnitTestHostBaseLib.EnableDisableInterrupts ();
}
...
{
  return gUnitTestHostBaseLib.GetInterruptState ();
}
