...
// From JEP106BO, published May 2026.
...
GLOBAL_REMOVE_IF_UNREFERENCED
GLOBAL_REMOVE_IF_UNREFERENCED
STATIC CONST JEDEC_MANUFACTURERS  Jep106ManufacturersBank15[] = {
  { 0x01, "Kalray SA"                                   },
...
GLOBAL_REMOVE_IF_UNREFERENCED
STATIC CONST JEDEC_MANUFACTURERS  Jep106ManufacturersBank16[] = {
  { 0x01, "CXSH"                                        },
  { 0x02, "Synconv"                                     },
  { 0x83, "MULTIUNIT"                                   },
...
GLOBAL_REMOVE_IF_UNREFERENCED
STATIC CONST JEDEC_MANUFACTURERS  Jep106ManufacturersBank17[] = {
  ...
  { 0x45, "Great Wall Global Information Technology"    },
  ...
  { 0xFB, "Plusetech Technology (Shenzhen) Co Ltd"      },
  { 0x7C, "ChongQing YuJia Smart Storage Digital"       },
  { 0xFD, "CTST Co Ltd"                                 },
  { 0xFE, "SSK Corporation"                             },
  { 0xFF, ""                                            }
};

GLOBAL_REMOVE_IF_UNREFERENCED
STATIC CONST JEDEC_MANUFACTURERS  Jep106ManufacturersBank18[] = {
  { 0x01, "Shenzhen Xinruiyun Storage Technology"         },
  { 0x02, "JSC Megapolis-Telecom Region"                  },
  { 0x83, "Minpo Corporation"                             },
  { 0x04, "Shenzhen Yingzhong Technology Co Ltd"          },
  { 0x85, "Moment Semiconductor Inc"                      },
  { 0x86, "Yiweihong (Shenzhen) Electronic Technology Co" },
  { 0x07, "Shenzhen Dawei Microelectronics Technology Co" },
  { 0x08, "Shenzhen Zhuoran Electronics Co Ltd"           },
  { 0x89, "Mengxw Electron Ltd"                           },
  { 0x8A, "Origin Storage Ltd"                            },
  { 0x0B, "Shanghai RuiPan Electronic Information Tech"   },
  { 0x8C, "Fortell Research Inc"                          },
  { 0x0D, "Jiyi Semiconductor Co Ltd"                     },
  { 0x0E, "Shenzhen Silicon Hermit Technology Ltd"        },
  { 0x8F, "HuiRong Electronic System Engineering Co LTD"  },
  { 0x10, "ALBSEMI (Hangzhou) Co Ltd"                     },
  { 0x91, "ULX"                                           },
  { 0x92, "Sichuan Huazhixincun Technology Co Ltd"        },
  { 0x13, "Shenzhen Yunyue Semiconductor Co Ltd."         },
  { 0x94, "Fortune Sky Enterprise Limited"                },
  { 0x15, "Shenzhen Tianchuang Weiye Technology"          },
  { 0x16, "Shanghai Simchip Technology Group"             },
  { 0x97, "SVOD Project SRO"                              },
  { 0x98, "Shenzhen Xunnaying Technology Co Ltd"          },
  { 0x19, "Zhejiang Xinhan Intelligent Manufacturing"     },
  { 0x1A, "Shenzhen Tranvita Technology Co Ltd"           },
  { 0x9B, "Zhongke Zhichun (Zhuhai) Technology Co"        },
  { 0x1C, "Shenzhen Yunmemory AI Technology Co"           },
  { 0x9D, "Shenzhen KEHB Electronics Co Ltd"              },
  { 0x9E, "Shenzhen EVOC Storage Technology Co"           },
  { 0x1F, "Beijing ZhanChuang ZhenHua Technology Co"      },
  { 0x20, "Sichuan Huakun Zhenyu Intelligent Technology"  },
  { 0xA1, "Hunan Hongen Electronics Co Ltd"               },
  { 0xA2, "Shenzhen Youjing Microelectronics Technology"  },
  { 0x23, "Shenzhen Coosure Electronics Co Ltd"           },
  { 0xA4, "Seavo Future Technology (Shenzhen) Co Ltd"     },
  { 0x25, "ShenZhen Goodtimes Technology Co Ltd"          },
  { 0x26, "Shanxi Bluestone Guangzhi Technology Co Ltd"   },
  { 0xA7, "Shenzhen Lianrunfeng Electronic Technology Co" },
  { 0xA8, "Shenzhen Seapiy Technology Co Ltd"             },
  { 0x29, "Aivres Systems Inc"                            },
  { 0x2A, "Liveseek"                                      },
  { 0xAB, "Shenzhen KingSpec Electronics Technology"      },
  { 0x2C, "Shenzhen Qiben Electronics Co Ltd"             },
  { 0xAD, "Guangdong Shunwei Microelectronics Tech"       },
  { 0xAE, "Efficient Computer"                            },
  { 0x2F, "Shenzhen Powerleader Storage Technology"       },
  { 0xB0, "Shenzhen Chuangzhan Semiconductor Co Ltd"      },
  { 0x31, "Shenzhen Xbnow Technology Co Ltd"              },
  { 0x32, "YCHIPWAY Semiconductor Technology"             },
  { 0xB3, "Shenzhen Yansen Industrial Storage Co Ltd"     },
  { 0x34, "ARIA Sensing Srl"                              },
  { 0xB5, "EverModule Technology Co Ltd"                  },
  { 0xB6, "The AIO"                                       },
  { 0x37, "North Magna Limited"                           },
  { 0x38, "Unisemi Power Inc"                             },
  { 0xB9, "Shenzhen RongPei Technology Co Ltd"            },
  { 0xBA, "HKIC International Electronics Limited"        },
  { 0x3B, "Shenzhen DTX Space Technology Co Ltd"          },
  { 0xBC, "Ranxin Technology"                             },
  { 0xFF, ""                                              }
};
...
STATIC CONST JEDEC_MANUFACTURERS  *Jep106Manufacturers[] = {
  ...
  Jep106ManufacturersBank15,
  Jep106ManufacturersBank16,
  Jep106ManufacturersBank17,
  Jep106ManufacturersBank18
};
