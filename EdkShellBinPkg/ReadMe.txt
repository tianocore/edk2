The binaries of EdkShellBinPkg are generated with EFI shell project (svn r57) and build with Edk Compatibility & BaseTools Package (r12898). The binaries are built with no debug information by building with "RELEASE" target.
...
3. Check out Edk Shell project source (r57) to $(WORKSPACE)\Shell (svn https://efi-shell.svn.sourceforge.net/svnroot/efi-shell/trunk/Shell). 
