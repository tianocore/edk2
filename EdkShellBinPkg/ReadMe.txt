The binaries of EdkShellBinPkg are generated with EFI shell project (svn r50) and build with Edk Compatibility & BaseTools Package (r10348). The binaries are built with no debug information by building with "RELEASE" target.
...
3. Check out Edk Shell project source (r50) to $(WORKSPACE)\Shell (svn https://efi-shell.svn.sourceforge.net/svnroot/efi-shell/trunk/Shell). 
