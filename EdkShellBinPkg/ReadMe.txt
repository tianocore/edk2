...
3. Check out Edk Shell project source (r46) to $(WORKSPACE) (svn https://efi-shell.svn.sourceforge.net/svnroot/efi-shell/trunk/Shell). 
4. Update to the newest BaseTools package (r10348) to $(WORKSPACE) (svn https://edk2.svn.sourceforge.net/svnroot/edk2/trunk/edk2/BaseTools).
