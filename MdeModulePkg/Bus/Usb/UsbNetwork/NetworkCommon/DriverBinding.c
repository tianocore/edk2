  ...
  )
{
  ...
  NicDevice->NicInfo.RateLimitingEnable      =3D gRateLimitingEnable;
  NicDevice->NicInfo.RateLimitingCreditCount =3D 0;
  NicDevice->NicInfo.RateLimitingCredit      =3D gRateLimitingCredit;
  NicDevice->NicInfo.RateLimitingPollTimer   =3D gRateLimitingPollTimer;
  ...
  )
{
  ...
  gRateLimitingEnable                             =3D PcdGetBool (PcdEnableUsbNetworkRateLimiting);
  gRateLimitingCredit                             =3D PcdGet32 (PcdUsbNetworkRateLimitingCredit);
  gRateLimitingPollTimer                          =3D PcdGet32 (PcdUsbNetworkRateLimitingFactor);
