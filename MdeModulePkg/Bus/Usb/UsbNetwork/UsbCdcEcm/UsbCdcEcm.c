  ...
  )
{
  ...
  UsbEthDriver->UsbEth.UsbEthReceive               =3D UsbEthEcmReceive;
  UsbEthDriver->UsbEth.UsbEthTransmit              =3D UsbEthEcmTransmit;
  UsbEthDriver->UsbEth.UsbEthInterrupt             =3D UsbEthEcmInterrupt;
  UsbEthDriver->UsbEth.UsbEthMacAddress            =3D GetUsbEthMacAddress;
  UsbEthDriver->UsbEth.UsbEthMaxBulkSize           =3D UsbEthEcmBulkSize;
