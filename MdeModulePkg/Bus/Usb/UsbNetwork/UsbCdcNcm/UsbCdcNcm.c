  ...
  )
{
  ...
  UsbEthDriver->UsbEth.UsbEthReceive               =3D UsbEthNcmReceive;
  UsbEthDriver->UsbEth.UsbEthTransmit              =3D UsbEthNcmTransmit;
  UsbEthDriver->UsbEth.UsbEthInterrupt             =3D UsbEthNcmInterrupt;
  UsbEthDriver->UsbEth.UsbEthMacAddress            =3D GetUsbEthMacAddress;
  UsbEthDriver->UsbEth.UsbEthMaxBulkSize           =3D UsbEthNcmBulkSize;
