...
/**
  ...
  **/
UINT64 GetFieldValues(UINT64 RegisterValue, UINT32 StartingBit, UINT32 EndingBit);
...
/**
  ...
  **/
EFI_STATUS PciUefiMemRead32(CXL_CONTROLLER_PRIVATE_DATA *Private, UINT32 Start, UINT32 *Value);
...
/**
  ...
  **/
EFI_STATUS PciUefiMemRead64(CXL_CONTROLLER_PRIVATE_DATA *Private, UINT32 Start, UINT64 *Value);
...
/**
  ...
  **/
EFI_STATUS PciUefiMemWrite32(CXL_CONTROLLER_PRIVATE_DATA *Private, UINT32 Start, UINT32 *Value);
...
/**
  ...
  **/
EFI_STATUS PciUefiMemWrite64(CXL_CONTROLLER_PRIVATE_DATA *Private, UINT32 Start, UINT64 *Value);
