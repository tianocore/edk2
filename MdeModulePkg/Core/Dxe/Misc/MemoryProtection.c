...
//
// The Legacy BIOS WB region is only applicable for X64. For other
// architectures, this is set to 0 so that the region is not mapped
// if compatibility mode is activated.
//
#if defined (MDE_CPU_X64)
#define LEGACY_BIOS_WB_LENGTH  0xA0000
#else
#define LEGACY_BIOS_WB_LENGTH  0x0
#endif
