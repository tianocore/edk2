...
extern "C" {
  ...
  EFI_MEMORY_TYPE_STATISTICS_HEADER  mMemoryTypeStatistics = {
    ...
    {
      { 0, MAX_ALLOC_ADDRESS, 0, 0, 0, EfiMaxMemoryType, TRUE,  FALSE, FALSE },
      { 0, MAX_ALLOC_ADDRESS, 0, 0, 0, EfiMaxMemoryType, FALSE, FALSE, FALSE },
      { 0, MAX_ALLOC_ADDRESS, 0, 0, 0, EfiMaxMemoryType, FALSE, FALSE, FALSE,},
      { 0, MAX_ALLOC_ADDRESS, 0, 0, 0, EfiMaxMemoryType, FALSE, FALSE, FALSE,},
      { 0, MAX_ALLOC_ADDRESS, 0, 0, 0, EfiMaxMemoryType, FALSE, FALSE, FALSE,},
      { 0, MAX_ALLOC_ADDRESS, 0, 0, 0, EfiMaxMemoryType, TRUE,  TRUE,  FALSE,},
      { 0, MAX_ALLOC_ADDRESS, 0, 0, 0, EfiMaxMemoryType, TRUE,  TRUE,  FALSE,},
      { 0, MAX_ALLOC_ADDRESS, 0, 0, 0, EfiMaxMemoryType, FALSE, FALSE, FALSE,},
      { 0, MAX_ALLOC_ADDRESS, 0, 0, 0, EfiMaxMemoryType, FALSE, FALSE, FALSE,},
      { 0, MAX_ALLOC_ADDRESS, 0, 0, 0, EfiMaxMemoryType, TRUE,  FALSE, FALSE,},
