...
/**
  This function will get ACPI table from gAcpiTableHobGuid Guid hob and install Acpi table from it.
...
)
{
  ...
  //
  SiAcpiHobRsdp = (EFI_ACPI_3_0_ROOT_SYSTEM_DESCRIPTION_POINTER *) (AcpiSiliconHob->Rsdp);
  ...
  )
{
  ...
  if (GuidHob != NULL) {
    ...
    DEBUG ((DEBUG_ERROR, "Fail to locate AcpiSiliconHob!!\n"));
  }
