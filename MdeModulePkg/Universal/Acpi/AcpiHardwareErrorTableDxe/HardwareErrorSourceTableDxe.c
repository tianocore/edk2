...
PopulateErrorSourceStructures (
  IN  UINT32                                                          *RasAgentChannelIds,
  IN  UINT32                                                          NumChannelIds,
  OUT EFI_ACPI_6_5_GENERIC_HARDWARE_ERROR_SOURCE_VERSION_2_STRUCTURE  *BaseErrSrcStructure
  )
{
  EFI_STATUS                                                      Status;
  UINT32                                                          NumSources;
  ...
  UINT32                                                          ChannelIndex;
  UINT32                                                          Index;
  EFI_ACPI_6_5_GENERIC_HARDWARE_ERROR_SOURCE_VERSION_2_STRUCTURE  *TmpErrSrc;
  ...
  )
{
  ...
  Header           = &((EFI_ACPI_6_5_HARDWARE_ERROR_SOURCE_TABLE_HEADER *)HestTable)->Header;
  ...
  )
{
  ...
  EFI_ACPI_6_5_GENERIC_HARDWARE_ERROR_SOURCE_VERSION_2_STRUCTURE  *BaseErrSrcStructure;
