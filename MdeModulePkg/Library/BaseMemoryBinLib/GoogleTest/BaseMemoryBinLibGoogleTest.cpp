...
extern "C" {
  ...
  // External variables from BaseMemoryBinLib.c
...
protected:
    ...
    ) override
  {
    ...
    mMemoryTypeStatistics.NumEntries = EfiMaxMemoryType + 1;
...
TEST_F (BaseMemoryBinLibTest, CalculateTotalMemoryBinSizeNeededReturnsZeroWhenNoPagesAllocated) {
  ...
  TotalSize = CalculateTotalMemoryBinSizeNeeded (0);
...
TEST_F (BaseMemoryBinLibTest, CoreSetMemoryTypeInformationRangeSetsUpBinsCorrectly) {
  ...
  CoreSetMemoryTypeInformationRange (Start, Length);

  ASSERT_TRUE (mMemoryTypeInformationInitialized);

  ASSERT_EQ (mMemoryTypeStatistics.Statistics[EfiRuntimeServicesCode].BinNumberOfPages, (UINT64)20);
  ASSERT_EQ (mMemoryTypeStatistics.Statistics[EfiRuntimeServicesData].BinNumberOfPages, (UINT64)10);
  ASSERT_EQ (mMemoryTypeStatistics.Statistics[EfiReservedMemoryType].BinNumberOfPages, (UINT64)5);
  ASSERT_EQ (mMemoryTypeStatistics.Statistics[EfiACPIReclaimMemory].BinNumberOfPages, (UINT64)15);
  ASSERT_EQ (mMemoryTypeStatistics.Statistics[EfiACPIMemoryNVS].BinNumberOfPages, (UINT64)25);
...
TEST_F (BaseMemoryBinLibTest, UpdateMemoryStatisticsUpdatesInBinCorrectly) {
  ...
  ASSERT_EQ (mMemoryTypeStatistics.Statistics[EfiRuntimeServicesCode].CurrentNumberOfPagesInBin, (UINT64)10);
  ASSERT_EQ (mMemoryTypeStatistics.Statistics[EfiRuntimeServicesCode].CurrentNumberOfPagesOutOfBin, (UINT64)0);
}
...
TEST_F (BaseMemoryBinLibTest, UpdateMemoryStatisticsUpdatesOutOfBinCorrectly) {
  ...
  ASSERT_EQ (mMemoryTypeStatistics.Statistics[EfiRuntimeServicesCode].CurrentNumberOfPagesInBin, (UINT64)0);
  ASSERT_EQ (mMemoryTypeStatistics.Statistics[EfiRuntimeServicesCode].CurrentNumberOfPagesOutOfBin, (UINT64)10);
}
...
TEST_F (BaseMemoryBinLibTest, DoesNothingWhenNoPagesNeeded) {
  ...
  ASSERT_TRUE (mMemoryTypeInformationInitialized);
  ASSERT_EQ (mMemoryTypeStatistics.Statistics[EfiReservedMemoryType].BinNumberOfPages, (UINT64)0);
  ASSERT_EQ (mMemoryTypeStatistics.Statistics[EfiRuntimeServicesCode].BinNumberOfPages, (UINT64)0);
  ASSERT_EQ (mMemoryTypeStatistics.Statistics[EfiRuntimeServicesData].BinNumberOfPages, (UINT64)0);
  ASSERT_EQ (mMemoryTypeStatistics.Statistics[EfiACPIReclaimMemory].BinNumberOfPages, (UINT64)0);
  ASSERT_EQ (mMemoryTypeStatistics.Statistics[EfiACPIMemoryNVS].BinNumberOfPages, (UINT64)0);
}
...
TEST_F (BaseMemoryBinLibTest, GetMemoryTypeInformationResourceHobReturnsNotFoundWhenNoResourceHob) {
  ...
  ResourceHob = GetMemoryTypeInformationResourceHob (&HobStart);
