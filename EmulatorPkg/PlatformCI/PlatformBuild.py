...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # requested to be built when building VS2022, VS2019 or VS2017
        if self.env.GetValue("TOOL_CHAIN_TAG") == "VS2022" or \
           self.env.GetValue("TOOL_CHAIN_TAG") == "VS2019" or \
           self.env.GetValue("TOOL_CHAIN_TAG") == "VS2017":
