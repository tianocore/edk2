...
/**
  ...
  @param[in, out] ImageInfo          A pointer to the buffer in which firmware places the current image(s)
                                     ...
                                     May be NULL with a zero ImageInfoSize in order to determine the size of the buffer needed.
...
/**
  ...
  @param[in,out] Image           Points to the buffer where the current image is copied to.
                                 May be NULL with a zero ImageSize in order to determine the size of the buffer needed.
