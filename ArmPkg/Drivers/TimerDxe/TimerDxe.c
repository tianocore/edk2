  ...
  )
{
  ...
  if (ArmHasGicV5SystemRegisters ()) {
    TimerSecIntrNum  = GICV5_ARCH_TIMER_SEC_INTR_NUM;
    TimerIntrNum     = GICV5_ARCH_TIMER_INTR_NUM;
    TimerHypIntrNum  = GICV5_ARCH_TIMER_HYP_INTR_NUM;
    TimerVirtIntrNum = GICV5_ARCH_TIMER_VIRT_INTR_NUM;
  } else {
