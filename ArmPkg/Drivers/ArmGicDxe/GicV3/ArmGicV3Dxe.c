...
STATIC CONST GIC_REG_OPERATION_CONFIG  mGicOperationConfigMap[GicOpNumOps] = {
  {
    GicOpSetInterruptPriority,      // Operation
    32,                             // RegisterWidthBits
    8,                              // FieldWidthBits
    ARM_GIC_ICDIPR,                 // DistributorSpiOffset
    ARM_GIC_ICDIPR_E,               // DistributorExtSpiOffset
    ARM_GIC_ICDIPR,                 // RedistributorOffset
  },
  {
    GicOpEnableInterrupt,      // Operation
    32,                        // RegisterWidthBits
    1,                         // FieldWidthBits
    ARM_GIC_ICDISER,           // DistributorSpiOffset
    ARM_GIC_ICDISER_E,         // DistributorExtSpiOffset
    ARM_GICR_ISENABLER,        // RedistributorOffset
  },
  {
    GicOpDisableInterrupt,      // Operation
    32,                         // RegisterWidthBits
    1,                          // FieldWidthBits
    ARM_GIC_ICDICER,            // DistributorSpiOffset
    ARM_GIC_ICDICER_E,          // DistributorExtSpiOffset
    ARM_GICR_ICENABLER,         // RedistributorOffset
  },
  {
    GicOpIsInterruptEnabled, // Operation
    32,                      // RegisterWidthBits
    1,                       // FieldWidthBits
    ARM_GIC_ICDISER,         // DistributorSpiOffset
    ARM_GIC_ICDISER_E,       // DistributorExtSpiOffset
