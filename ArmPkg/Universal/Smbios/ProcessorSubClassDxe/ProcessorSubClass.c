 ...
 * @param[in,out] Type7Record    The Type 7 record to fill in
 *
**/
VOID
SetCacheArchitectureInformation (
  ...
  IN OUT SMBIOS_TABLE_TYPE7  *Type7Record
  )
{
  CSSELR_DATA  Csselr;
  CCSIDR_DATA  Ccsidr;
 ...
 *
 * @param[in,out] Type4Record The SMBIOS Type 4 record to fill in
 *
**/
VOID
SetProcessorIdField (
  IN OUT SMBIOS_TABLE_TYPE4 *Type4Record
)
{
  ARM_SMC_ARGS Args;
  INT32 SmcCallStatus;
