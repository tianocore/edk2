...
/**  Guid to open Firmware Image Directory via fwu_open
      Cf Platform Security Firmware Update for the A-profile specification,
      1.0 A3.5 or A3.8 Image properties in given FW bank version 1 & 2.
 */
...
/** Metadata image entry version 1.
    Cf Platform Security Firmware Update for the A-profile specification,
    1.0, A.3.2.3 "Metadata version 1"
 */
typedef struct {
  ...
  PSA_MM_FWU_IMAGE_PROPERTIES             Properties[];
} PSA_MM_FWU_IMAGE_ENTRY_V1;
...
typedef struct {
  ...
  PSA_MM_FWU_IMAGE_ENTRY_V1            ImageEntry[];
} PSA_MM_FWU_METADATA_V1;
