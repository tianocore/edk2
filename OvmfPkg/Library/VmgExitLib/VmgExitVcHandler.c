...
#include <Register/VmgExitLibInstructionParsing.h>

//
// Non-automatic Exit function prototype
//   Only used locally to simplify coding
//
typedef
UINT64
(*NAE_EXIT) (
...
//   Only used locally for #VC processing
//
typedef struct {
  BOOLEAN  Dr7Cached;
  UINT64   Dr7;
  ...
  )
{
  ...
  Mode = LongMode64Bit;       // TODO: Determine current mode - 64-bit for now
