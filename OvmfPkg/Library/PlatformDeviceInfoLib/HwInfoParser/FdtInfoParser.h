...
typedef struct PlatDevInfo {
  ...
  PLATFORM_DEVICE_INFO    *Dev;

  /// The max count of devices that can be accomodated in the platfrom device
  /// info.
  UINTN                   MaxDevices;

  /// The count of devices for which the infromation is populated in the
  /// platform device info.
  UINTN                   DevCount;
} PLATFORM_DEVICE_INFO_CONTEXT;
