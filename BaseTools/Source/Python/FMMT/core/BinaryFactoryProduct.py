        ...
        while Rel_Offset < Data_Size:
            ...
            if Section_Info.Header.Type == 0x19:
                if ParTree.Data.IsFsp:
                    ...
                    logger.debug(f'ParTree.Parent.Data.ImageSize : {hex(ParTree.Parent.Data.ImageSize)}')
                    logger.debug(f'ParTree.Parent.Data.BaseAddress : {hex(ParTree.Parent.Data.BaseAddress)}')
