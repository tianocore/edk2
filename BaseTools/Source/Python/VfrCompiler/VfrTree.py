...
class VfrTree():
    ...
    def GenBinaryFiles(self, InputFile):
        ...
        try:
            ...
            EdkLogger.error("VfrCompiler", FILE_OPEN_FAILURE,
                            "File open failed for %s" % HpkFile, None)
        ...
        try:
            ...
            BaseName = 'unsigned char ' + InputFile[:InputFile.
                                                    find('.')] + 'Bin[] = {\n'
            C.write(BaseName)
            ...
            EdkLogger.error("VfrCompiler", FILE_OPEN_FAILURE,
                            "File open failed for %s" % CFile, None)
        ...
        try:
            ...
            EdkLogger.error("VfrCompiler", FILE_OPEN_FAILURE,
                            "File open failed for %s" % LstFile, None)
        ...
        try:
            ...
            EdkLogger.error("VfrCompiler", FILE_OPEN_FAILURE,
                            "File open failed for %s" % InputFile, None)
            ...
            if Root.Buffer != None:
                try:
                    ...
                    EdkLogger.error(
                        ...
                        (InputFile[:InputFile.find('.')] + '.hpk'), None)
                ...
                try:
                    ...
                    EdkLogger.error(
                        "VfrCompiler", FILE_WRITE_FAILURE,
                        "File write failed for %s" %
                        (InputFile[:InputFile.find('.')] + '.c'), None)
    ...
    def GenCFile(self, InputFile):
        ...
        try:
            with open(FileName, 'w') as f:
                ...
                BaseName = 'unsigned char ' + InputFile[:InputFile.find(
                    '.')] + 'Bin[] = {\n'
                f.write(BaseName)
    ...
    def GenRecordListFile(self, InputFile):
        ...
        try:
            ...
            EdkLogger.error(
                ...
                (InputFile[:InputFile.find('.')] + '.lst'), None)
    ...
    def DumpYaml(self, InputFile):
        FileName = InputFile[:InputFile.find('.')] + '.yml'
        try:
            with open(FileName, 'w') as f:
    ...
    def DumpYamlDfs(self, Root, f, InputFile):
        try:
            ...
            EdkLogger.error(
                "VfrCompiler", FILE_WRITE_FAILURE, "File write failed for %s" %
                (InputFile[:InputFile.find('.')] + '.yaml'), None)
