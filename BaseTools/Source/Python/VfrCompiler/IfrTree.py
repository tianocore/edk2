        ...
        try:
            if Root.OpCode != None:
                ...
                if Root.OpCode == EFI_IFR_FORM_SET_OP:
                    ...
                    f.write(
                        ...
                        + "{}, {}, {}, {}, {}, {}, {}, {}".format(
                            ...
                            "0x%x" % (Info.Guid.Data4[1]),
                            "0x%x" % (Info.Guid.Data4[2]),
                            "0x%x" % (Info.Guid.Data4[3]),
                            "0x%x" % (Info.Guid.Data4[4]),
                            "0x%x" % (Info.Guid.Data4[5]),
                            "0x%x" % (Info.Guid.Data4[6]),
                            "0x%x" % (Info.Guid.Data4[7]),
                        )
                        + " }}'\n"
                    )
                ...
                if Root.OpCode == EFI_IFR_FORM_MAP_OP:
                    ...
                    f.write(KeyIndent + "- formmap: \n")
                    # f.write(ValueIndent + 'buffer:  {}\n'.format(self.DumpBuffer(Root)))
                    f.write(ValueIndent + "formid:  {} # FormId STRING_ID\n".format(Info.FormId))
                    if Root.Condition != None:
                        f.write(ValueIndent + "condition:  '{}'\n".format(Root.Condition))
                    if MethodMapList != []:
                        f.write(ValueIndent + "map: # optional input, for reference\n")
                    for MethodMap in MethodMapList:
                        f.write(ValueIndent + "- maptitle:  {}\n".format(MethodMap.MethodTitle))
                        f.write(
                            ValueIndent
                            + "  mapguid:  '{"
                            + "{}, {}, {},".format(
                                "0x%x" % (MethodMap.MethodIdentifier.Data1),
                                "0x%x" % (MethodMap.MethodIdentifier.Data2),
                                "0x%x" % (MethodMap.MethodIdentifier.Data3),
                            )
                            + " { "
                            + "{}, {}, {}, {}, {}, {}, {}, {}".format(
                                "0x%x" % (MethodMap.MethodIdentifier.Data4[0]),
                ...
                if Root.OpCode == EFI_IFR_REF_OP:
                    ...
                    if type(Root.Data) == IfrRef4:
                        ...
                        f.write(
                            ...
                            + "formsetguid:  '{"
                            + "{}, {}, {},".format(
                                "0x%x" % (Info.FormSetId.Data1),
                                "0x%x" % (Info.FormSetId.Data2),
                                "0x%x" % (Info.FormSetId.Data3),
                            )
                            + " { "
                            + "{}, {}, {}, {}, {}, {}, {}, {}".format(
                                "0x%x" % (Info.FormSetId.Data4[0]),
                                "0x%x" % (Info.FormSetId.Data4[1]),
                                "0x%x" % (Info.FormSetId.Data4[2]),
                                "0x%x" % (Info.FormSetId.Data4[3]),
                                "0x%x" % (Info.FormSetId.Data4[4]),
                                "0x%x" % (Info.FormSetId.Data4[5]),
                                "0x%x" % (Info.FormSetId.Data4[6]),
                ...
                if Root.OpCode == EFI_IFR_REFRESH_ID_OP:
                    ...
                    f.write(
                        ...
                        + "guid:  '{"
                        + "{}, {}, {},".format(
                            "0x%x" % (Info.RefreshEventGroupId.Data1),
                            "0x%x" % (Info.RefreshEventGroupId.Data2),
                            "0x%x" % (Info.RefreshEventGroupId.Data3),
                        )
                        + " { "
                        + "{}, {}, {}, {}, {}, {}, {}, {}".format(
                            "0x%x" % (Info.RefreshEventGroupId.Data4[0]),
