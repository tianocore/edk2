...
def main():
    if sys.platform == 'win32':
        ...
        # There is a corner case for the Raspberry Pi. Sometimes has a 64-bit
        # kernel paired with an exclusively 32-bit user mode, detect this case.
