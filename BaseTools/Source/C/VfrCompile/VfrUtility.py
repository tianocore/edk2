...
class CVfrVarDataTypeDB(object):
    ...
    # two definitions
    def GetDataTypeSize(self, TypeName):
        Size = 0
...
class CVfrDefaultStore(object):
    ...
    def RegisterDefaultStore(self, RefName, DefaultStoreNameId, DefaultId):
        if RefName == '':
            return VfrReturnCode.VFR_RETURN_FATAL_ERROR
        ...
        pNode = SVfrDefaultStoreNode(RefName, DefaultStoreNameId, DefaultId)
    ...
    def ReRegisterDefaultStoreById(self, DefaultId, RefName,
        ...
        if pNode == None:
            ...
            if pNode.DefaultStoreNameId == EFI_STRING_ID_INVALID:
                ...
                if pNode.ObjBinAddr != None:
                    pNode.ObjBinAddr.DefaultName = DefaultStoreNameId
            else:
                return VfrReturnCode.VFR_RETURN_REDEFINED
