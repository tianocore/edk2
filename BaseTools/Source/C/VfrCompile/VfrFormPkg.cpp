...
VOID SPendingAssign::SetAddrAndLen(
    IN VOID *Addr,
    IN UINT32 LineNo)
{
  mAddr = Addr;
...
VOID SPendingAssign::AssignValue(
    IN VOID *Addr,
    IN UINT32 Len)
{
...
bool CFormPkg::HavePendingUnassigned(
    VOID)
{
  SPendingAssign *pNode;
...
VOID CFormPkg::PendingAssignPrintAll(
    VOID)
{
  SPendingAssign *pNode;
...
VOID CIfrRecordInfoDB::IfrRecordInfoUpdate(
    IN UINT32 RecordIdx,
    IN UINT32 LineNo,
    IN CHAR8 *BinBuf,
    IN UINT8 BinBufLen,
...
VOID CIfrRecordInfoDB::IfrRecordOutput(
    OUT PACKAGE_DATA &TBuffer)
{
  CHAR8 *Temp;
  SIfrRecord *pNode;
...
**/
VOID CIfrRecordInfoDB::IfrUpdateRecordInfoForDynamicOpcode(
    IN BOOLEAN CreateOpcodeAfterParsingVfr)
{
  SIfrRecord *pRecord;
...
VOID CIfrRecordInfoDB::IfrAdjustOffsetForRecord(
    VOID)
{
  UINT32 OpcodeOffset;
  SIfrRecord *pNode;
...
**/
VOID CIfrRecordInfoDB::IfrAddDefaultToBufferConfig(
    IN UINT16 DefaultId,
...
**/
VOID CIfrRecordInfoDB::IfrGetDefaultStoreInfo(
    VOID)
{
  SIfrRecord *pNode;
...
**/
VOID CIfrRecordInfoDB::IfrCreateDefaultRecord(
    IN UINT8 Size,
    IN UINT16 DefaultId,
    IN UINT8 Type,
    IN UINT32 LineNo,
...
**/
VOID CIfrRecordInfoDB::IfrCreateDefaultForQuestion(
    IN SIfrRecord *pQuestionNode,
...
**/
VOID CIfrRecordInfoDB::IfrParseDefaulInfoInQuestion(
    IN SIfrRecord *pQuestionNode,
...
**/
VOID CIfrRecordInfoDB::IfrCheckAddDefaultRecord(
    BOOLEAN AutoDefault,
...
VOID CIfrObj::_EMIT_PENDING_OBJ(
    VOID)
{
...
CIfrOpHeader::CIfrOpHeader(
    IN UINT8 OpCode,
    IN VOID *StartAddr,
    IN UINT8 Length) : mHeader((EFI_IFR_OP_HEADER *)StartAddr)
{
...
UINT32 CIfrFormId::FormIdBitMap[EFI_FREE_FORM_ID_BITMAP_SIZE] = {
    0,
};
