...
STATIC ARMCCA_TCG2_DXE_DATA  mArmCcaDxeData = {
  {
    ...
    { EFI_ACPI_6_5_CC_TYPE_ARMCCA, 0 }       // {CC_TYPE, CC_SUBTYPE}
  },
};
...
*/
STATIC EFI_ACPI_6_5_CONFIDENTIAL_COMPUTING_EVENT_LOG_TABLE  mArmCcaEventlogAcpiTemplate = {
  {
  ...
  EFI_ACPI_6_5_CC_TYPE_ARMCCA,        // Cc Type
  0,                                  // CC Sub Type
