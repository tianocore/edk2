...
MM_EVENT_NOTIFICATION  mMmEvents[] = {
  ...
  //
  { ProtocolNotify, TRUE,  &gEfiDxeSmmReadyToLockProtocolGuid, MmReadyToLockEventNotify,     &gEfiDxeSmmReadyToLockProtocolGuid, NULL },
  //
  ...
  //
  { EventNotify,    FALSE, &gEfiEventVirtualAddressChangeGuid, MmVariableAddressChangeEvent, NULL,                               NULL },
  //
