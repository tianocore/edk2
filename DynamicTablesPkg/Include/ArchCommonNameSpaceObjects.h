...
typedef enum ArchCommonObjectID {
  ...
  EArchCommonObjSerialTerminalInterruptInfo,    ///< 45 - Serial Terminal and Interrupt Info
  EArchCommonObjMax
...
/** A structure that describes the Serial Terminal and Interrupt Information.
  ...
  ID: EArchCommonObjSerialTerminalInterruptInfo
*/
typedef struct CmArchCommonObjSerialTerminalInterruptInfo {
