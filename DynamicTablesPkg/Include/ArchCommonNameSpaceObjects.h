...
typedef enum ArchCommonObjectID {
  ...
  EArchCommonObjProximityDomainInfo,            ///< 37 - Proximity Domain Info
  EArchCommonObjProximityDomainRelationInfo,    ///< 38 - Proximity Domain Relation Info
  EArchCommonObjSystemLocalityInfo,             ///< 39 - System Locality Info
  EArchCommonObjMemoryProximityDomainAttrInfo,  ///< 40 - Memory Proximity Domain Attribute
  EArchCommonObjMemoryLatBwInfo,                ///< 41 - Memory Latency Bandwidth Info
  EArchCommonObjMemoryCacheInfo,                ///< 42 - Memory Cache Info
  EArchCommonObjMax
