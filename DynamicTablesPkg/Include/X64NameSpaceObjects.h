...
typedef struct Ia32ErrSourceMachineCheckCommonInfo {
  ...
  /// OSPM is responsible for directly handling the error
  BOOLEAN                   GhesAssist;
  ...
  /// Token Array for associated hardware banks.
  CM_ARCH_COMMON_OBJ_REF    MachineBankInfoTokenArray;
} MACHINE_CHECK_COMMON_INFO;
 ...
 */
typedef struct Ia32ErrSourceMachineCheckExceptionInfo {
  /// An unique token used to identify this object
  CM_OBJECT_TOKEN              Token;
  MACHINE_CHECK_COMMON_INFO    Common;
 ...
 */
typedef struct Ia32ErrSourceCorrectedMachineCheckInfo {
  /// An unique token used to identify this object
  CM_OBJECT_TOKEN                                       Token;
  MACHINE_CHECK_COMMON_INFO                             Common;
 ...
 */
typedef struct Ia32ErrSourceDeferredMachineCheckInfo {
  /// An unique token used to identify this object
  CM_OBJECT_TOKEN                                       Token;
  MACHINE_CHECK_COMMON_INFO                             Common;
  EFI_ACPI_6_6_HARDWARE_ERROR_NOTIFICATION_STRUCTURE    NotificationInfo;
 ...
 */
typedef struct Ia32ErrSourceNmiInfo {
  /// The number of error records to pre-allocate for this error source.
  UINT32    NumberOfRecordsToPreAllocate;
