...
/** Find an index of the specified doamin ID in an array.
  ...
  )
{
  ...
  UINT8  *TablePtr = (UINT8 *)MemLatBwInfo;
  ...
  // Update record info
  MemLatBwInfo->Length                            = GetSllbiTableSize (InitiatorDomainCount, TargetDomainCount);
...
/** Add the MemProxDomainAttr Information record to the HMAT Table.
  ...
  @param [in]  MemProximityDomainAttrInfo       Pointer to a Proximity Domain Attribute array in an HMAT table.
                                                ...
                                                the data.
  @param [in]  CmMemProximityDomainAttrInfo     Pointer ConfigurationManager objects array wuth Domain Attribute data.
  ...
  )
{
  ...
  while (MemProximityDomainAttrCount-- != 0) {
    ...
    MemProximityDomainAttrInfo->InitiatorProximityDomain = DomainId;
    ...
    MemProximityDomainAttrInfo->MemoryProximityDomain = DomainId;
  ...
  )
{
  ...
  *Table = NULL;
  ...
  MaxLatBwSize = GetSllbiTableSize (ProximityDomainInfoCount, ProximityDomainInfoCount);
