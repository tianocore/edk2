  ...
  )
{
  ...
  Status = SetMachineCheckCommonErrSourceInfo (
             ErrSourceOps->ErrSourceType,
             SourceId,
             Flags,
             MachineCheckCommon,
  ...
  )
{
  ...
  UINT16                                                          RelatedSourceId;
  CONST GHES_COMMON_INFO                                          *GhesCommon;
  CONST CM_ARCH_COMMON_ERROR_SOURCE_GENERIC_HW_VERSION2_INFO      *GhesV2Info;
  ...
  switch (ErrSourceOps->ErrSourceType) {
    case EFI_ACPI_6_6_GENERIC_HARDWARE_ERROR:
      break;
    case EFI_ACPI_6_6_GENERIC_HARDWARE_ERROR_VERSION_2:
      GhesV2Info                = (CONST CM_ARCH_COMMON_ERROR_SOURCE_GENERIC_HW_VERSION2_INFO *)GhesCommon;
...
STATIC ERR_SOURCE_OPS  HestErrSourceOps[] = {
  ...
  },
  {
    ...
    sizeof (CM_ARCH_COMMON_ERROR_SOURCE_GENERIC_HW_VERSION2_INFO),
    0,
    GetGhesCmObj,
    GetAdditionalSizeofGhes,
    AddGhes,
