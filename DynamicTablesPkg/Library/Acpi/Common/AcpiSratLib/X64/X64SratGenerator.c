  ...
  )
{
  ...
  if (CmX2ApicAffinity->ApicMode == LocalApicModeX2Apic) {
    ...
    while (mSratSubTable[EX64LocalApicX2ApicAffinityTableType].Count-- != 0) {
      ...
      X2ApicAffinity->Reserved1[0]    = 0;
      X2ApicAffinity->Reserved1[1]    = 0;
      ...
      X2ApicAffinity->Reserved2[0]    = 0;
      X2ApicAffinity->Reserved2[1]    = 0;
      X2ApicAffinity->Reserved2[2]    = 0;
      X2ApicAffinity->Reserved2[3]    = 0;
      X2ApicAffinity++;
      // Next
      CmX2ApicAffinity++;
    }
