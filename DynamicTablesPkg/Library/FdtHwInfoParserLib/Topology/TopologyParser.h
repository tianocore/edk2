...
//
// TOPOLOGY_PROC_HIERARCHY_BUFFERS.CpuMasks[TOPOLOGY_MASK_SIZE]
// is used as a bitmask. Each cell of the array can identify
// 64 CPUs (cf. UINT64)
//
#define TOPOLOGY_CPUS_PER_INDEX  (64U)
...
typedef struct {
  ...
  /// 0 for the top level node, 1 for the next level, etc.
  ///
  UINT32                                Depth;
