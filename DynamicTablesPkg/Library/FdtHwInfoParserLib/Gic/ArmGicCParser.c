...
)
{
  ...
  // To fit the Affinity [0-3] on the MpIdr, place the Aff3 on bits
  ...
  */
  if (GicVersion == 2) {
    GicCInfo->CPUInterfaceNumber = MpIdr;
  } else {
    GicCInfo->CPUInterfaceNumber = 0;
  }

  GicCInfo->AcpiProcessorUid = MpIdr;
