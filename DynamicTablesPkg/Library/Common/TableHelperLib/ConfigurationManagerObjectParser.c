...
/** A parser for EArchCommonObjSerialTerminalInterruptInfo.
*/
STATIC CONST CM_OBJ_PARSER  CmArchCommonSerialTerminalInterruptInfoParser[] = {
...
STATIC CONST CM_OBJ_PARSER_ARRAY  ArchCommonNamespaceObjectParser[] = {
  ...
  CM_PARSER_ADD_OBJECT (EArchCommonObjSerialTerminalInterruptInfo,  CmArchCommonSerialTerminalInterruptInfoParser),
