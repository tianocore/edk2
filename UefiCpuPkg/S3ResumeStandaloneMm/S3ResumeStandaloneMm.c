  ...
  )
{
  ...
  //
  // Register SmmEndOfS3ResumeHandler
  //
  Status = gMmst->MmRegisterProtocolNotify (&gEfiSmmEndOfDxeProtocolGuid, EndOfDxeEventNotify, &Registration);
  ASSERT_EFI_ERROR (Status);

  // Todo: collect PcdAcpiS3Enable from hob.
