...
/**
  ...
  @retval RETURN_INVALID_PARAMETER  For non-present range, Mask->Bits.Present is 1, Attr->Bits.Present is 0 but some other attributes are provided.
  @retval RETURN_INVALID_PARAMETER  For non-present range, Mask->Bits.Present is 1, Attr->Bits.Present is 1 but some other attributes are not provided.
...
/**
  ...
  @retval RETURN_INVALID_PARAMETER  For non-present range, Mask->Bits.Present is 1, Attr->Bits.Present is 0 but some other attributes are provided.
  @retval RETURN_INVALID_PARAMETER  For non-present range, Mask->Bits.Present is 1, Attr->Bits.Present is 1 but some other attributes are not provided.
  @retval RETURN_INVALID_PARAMETER  For present range, Mask->Bits.Present is 1, Attr->Bits.Present is 0 but some other attributes are provided.
