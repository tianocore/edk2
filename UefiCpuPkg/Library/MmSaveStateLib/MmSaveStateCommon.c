...
CONST CPU_MM_SAVE_STATE_REGISTER_RANGE  mSmmSmramCpuRegisterRanges[] = {
...
extern CONST CPU_MM_SAVE_STATE_LOOKUP_ENTRY  mSmmSmramCpuWidthOffset[];
  ...
  )
{
  ...
  for (Index = 0, Offset = MM_SAVE_STATE_REGISTER_MAX_INDEX; mSmmSmramCpuRegisterRanges[Index].Length != 0; Index++) {
