...
/**
  ...
  @param[in, out]  DdtParent  The parent node to add a child to.
...
/**
  Find the device context for the requested device_id, allocating it if necessary.

  @param[in]  IoMmuContext   The context struct of an IOMMU.
  @param[in]  IoMmuDeviceId  The targeted IOMMU device_id.
...
/**
  ...
  @param[in]  IoMmuContext        The context struct of an IOMMU.
  @param[in]  IoMmuDeviceId       The targeted IOMMU device_id.
  @param[in]  DeviceContext       The device context pointer.
  @param[in]  DeviceAddress       The address to map.
  @param[in]  Length              The number of bytes to map.
  @param[in]  RiscVMmuAccessBits  Access permissions.

  @retval EFI_INVALID_PARAMETER   The SATP mode was not valid.
  @retval EFI_OUT_OF_RESOURCES    Not enough resource.
  @retval EFI_DEVICE_ERROR        The SATP mode is not supported by HW.
...
/**
  ...
  @param[in] Offset        A pointer to the offset returned.
  @param[in] NextRegBlock  A pointer to the next block returned.
...
/**
  ...
  @param[in]  PciIo          The PciIo protocol (for PCI devices).
