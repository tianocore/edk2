...
GoogleTest requires less overhead to register test suites and test cases than the Framework and
there are a number of tools that layer on top of GoogleTest that improve developer productivity.
For example, the VS Code extension
[C++ TestMate](https://marketplace.visualstudio.com/items?itemName=matepek.vscode-catch2-test-adapter)
is ued to implement, run, and debug unit tests implemented using GoogleTest.
