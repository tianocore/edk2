...
#define CHECK_RECORD_COUNT       1
#define SKIP_CHECK_RECORD_COUNT  0
...
STATIC CONST ACPI_PARSER  HestErrorIA32ArchMachineCheckBankStructureParser[] = {
  ...
  { L"Control Register MSR Address",   4, 4,  L"0x%x", NULL, NULL, NULL, NULL },
  { L"Control Init Data",              8, 8,  L"0x%x", NULL, NULL, NULL, NULL },
  { L"Status Register MSR Address",    4, 16, L"0x%x", NULL, NULL, NULL, NULL },
  { L"Address Register MSR Address",   4, 20, L"0x%x", NULL, NULL, NULL, NULL },
  { L"Misc Register MSR Address",      4, 24, L"0x%x", NULL, NULL, NULL, NULL },
};
...
STATIC CONST ACPI_PARSER  HestErrorNotificationParser[] = {
  { L"Type",                               1, 0,  L"%d",    NULL, NULL, ValidateErrorNotificationType, NULL },
  { L"Length",                             1, 1,  L"%d",    NULL, NULL, NULL,                          NULL },
  { L"Configuration Write Enable",         2, 2,  L"0x%x",  NULL, NULL, NULL,                          NULL },
...
{
  UINT8  RecordCount;
  UINTN  CheckRecordCount;

  RecordCount      = *Ptr;
  CheckRecordCount = (UINTN)Context;

  if ((CheckRecordCount != 0) && (RecordCount == 0)) {
    IncrementErrorCount ();
...
#define PARSE_HEST_ERROR_SOURCE_COMMON_HEADER(FlagsValidateFunc, CheckRecordCount)   \
  ...
  { L"Number of Records to Pre-allocate", 4, 8, L"%d", NULL, NULL,            \
    ValidateRecordCount, (VOID *) CheckRecordCount },                         \
...
#define PARSE_HEST_PCI_ERROR_SOURCE_COMMON_HEADER()                           \
  PARSE_HEST_ERROR_SOURCE_COMMON_HEADER(ValidatePciErrorSourceFlags, CHECK_RECORD_COUNT),      \
  ...
  { L"Uncorrectable Error Mask", 4, 28, L"0x%x", NULL, NULL, NULL, NULL },    \
  { L"Uncorrectable Error Severity", 4, 32, L"%d", NULL, NULL, NULL, NULL },  \
  { L"Correctable Error Mask", 4, 36, L"0x%x", NULL, NULL, NULL, NULL },      \
...
#define PARSE_HEST_GHES_ERROR_SOURCE()                                        \
  ...
  { L"Enabled", 1, 7, L"%d", NULL, NULL, ValidateEnabledField, NULL },        \
  { L"Number of Records to Pre-allocate", 4, 8, L"%d", NULL, NULL,            \
    ValidateRecordCount, (VOID *) CHECK_RECORD_COUNT },                       \
  { L"Max Sections Per Record", 4, 12, L"%d", NULL, NULL,                     \
    ValidateRecordCount, (VOID *) CHECK_RECORD_COUNT },                       \
...
STATIC CONST ACPI_PARSER  HestErrorSourceIA32ArchMachineCheckExceptionParser[] = {
  PARSE_HEST_ERROR_SOURCE_COMMON_HEADER (ValidateIA32ErrorSourceFlags, SKIP_CHECK_RECORD_COUNT),
  { L"Global Capability Init Data",
    8,                                                                 16,                      L"0x%x",  NULL, NULL,                                 NULL, NULL },
  { L"Global Control Init Data",
    8,                                                                 24,                      L"0x%x",  NULL, NULL,                                 NULL, NULL },
...
STATIC CONST ACPI_PARSER  HestErrorSourceIA32ArchCorrectedMachineCheckParser[] = {
  PARSE_HEST_ERROR_SOURCE_COMMON_HEADER (ValidateIA32ErrorSourceFlags, CHECK_RECORD_COUNT),
...
STATIC CONST ACPI_PARSER  HestErrorSourcePciExpressBridgeAerParser[] = {
  ...
  { L"Secondary Uncorrectable Error Mask",
    4,                                         44,  L"0x%x", NULL, NULL, NULL, NULL },
  ...
  )
{
  ...
  if (Offset < AcpiTableLength) {
    IncrementErrorCount ();
    Print (
      L"ERROR: Invalid Error Source Count, There's more data... Count:%d\n",
      *mHestErrorSourceType
      );
    return;
  }
