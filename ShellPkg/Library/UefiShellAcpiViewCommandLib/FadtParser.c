...
STATIC CONST UINT8*  FadtMajorRevision;
...
STATIC CONST ACPI_PARSER FadtParser[] = {
  PARSE_ACPI_HEADER (NULL, NULL, &FadtMajorRevision),
  ...
  {L"FADT Minor Version", 1, 131, L"0x%x", NULL, (VOID**)&FadtMinorRevision, NULL, NULL},
  ...
  )
{
  ...
  if (Trace) {
    PrintFieldName (0, L"FADT Version");
    Print (L"%d.%d\n",  *FadtMajorRevision, *FadtMinorRevision);
