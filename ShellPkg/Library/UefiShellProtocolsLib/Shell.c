  ...
  )
{
  ...
  InitializeListHead (&ShellProtocolsInfoObject.SplitList.Link);
  ...
  )
{
  ...
  if (!IsListEmpty (&ShellProtocolsInfoObject.SplitList.Link)) {
    ...
    for ( Split = (SPLIT_LIST *)GetFirstNode (&ShellProtocolsInfoObject.SplitList.Link)
          ; !IsNull (&ShellProtocolsInfoObject.SplitList.Link, &Split->Link)
          ; Split = (SPLIT_LIST *)GetNextNode (&ShellProtocolsInfoObject.SplitList.Link, &Split->Link)
          )
    {
  ...
  )
{
  ...
  InsertHeadList (&ShellProtocolsInfoObject.SplitList.Link, &Split->Link);
  ...
  //
  ASSERT ((SPLIT_LIST *)GetFirstNode (&ShellProtocolsInfoObject.SplitList.Link) == Split);
  RemoveEntryList (&Split->Link);
