  ...
  )
{
  ...
  //
  ShellProtocolInteractivityInfoObject.ImageDevPath               = NULL;
  ShellProtocolInteractivityInfoObject.FileDevPath                = NULL;
  ...
  //
  Status = GetDevicePathsForImageAndFile (&ShellProtocolInteractivityInfoObject.ImageDevPath, &ShellProtocolInteractivityInfoObject.FileDevPath);
...
FreeResources:
  ...
  if (ShellProtocolInteractivityInfoObject.ImageDevPath != NULL) {
    FreePool (ShellProtocolInteractivityInfoObject.ImageDevPath);
    DEBUG_CODE (
      ShellProtocolInteractivityInfoObject.ImageDevPath = NULL;
      );
  }

  if (ShellProtocolInteractivityInfoObject.FileDevPath != NULL) {
    FreePool (ShellProtocolInteractivityInfoObject.FileDevPath);
    DEBUG_CODE (
      ShellProtocolInteractivityInfoObject.FileDevPath = NULL;
      );
  }
