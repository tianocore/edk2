...
public class ModulePackageDependencies extends IInternalFrame {
    ...
    private JButton getJButtonAdd() {
        if (jButtonAdd == null) {
            ...
            jButtonAdd.setBounds(new java.awt.Rectangle(230, 445, 80, 20));
    ...
    private JButton getJButtonRemove() {
        if (jButtonRemove == null) {
            ...
            jButtonRemove.setBounds(new java.awt.Rectangle(400, 445, 80, 20));
    ...
    private JButton getJButtonUpdate() {
        if (jButtonUpdate == null) {
            ...
            jButtonUpdate.setBounds(new java.awt.Rectangle(315, 445, 80, 20));
